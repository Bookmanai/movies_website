...
<div class="wrapper d-flex align-items-stretch">
    <nav id="sidebar" class="active">
        <div class="p-4">
            <h1><a href="{{route('producers.index')}}" class="logo">Menu</a></h1>
                        ...
                        <table class="table table-bordered">
                            ...
                            @foreach($producers as $producer)
                                <tr>
                                    ...
                                    <td><img src="{{Storage::url($producer->photo)}}" width="100"></td>
                                    <td class="text-center">
                                        <a href="{{ route('producers.edit', $producer->id)}}" class="btn btn-primary btn-sm">Edit</a>
                                        <form action="{{ route('producers.destroy', $producer->id)}}" method="post" style="display: inline-block">
                                            @csrf
                                            @method('DELETE')
